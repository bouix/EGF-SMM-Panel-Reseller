@extends('layouts.app')
@section('title', getOption('app_name') . ' - Payza')
@section('content')
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-form">
                <div style="text-align: center;">
                    <img src="https://www.payza.com/images/payza-logo.png" alt="PayPal Logo">
                </div>
                <form id="payment-form"
                      role="form"
                      method="POST"
                      action="{{ url('/payment/add-funds/payza') }}">
                    {{ csrf_field() }}
                ...
                <p class="text-center"><small>@lang('forms.payza_fee')</small></p>
            </div>
        </div>
    </div>
@endsection
